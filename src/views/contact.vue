    ...
    <main class="min-h-screen">
      ...
      <!-- Navigation Section Start -->
        <section id="navbar" >
          ...
          <li class="text-sm font-bold text-gray-300 md:text-gray-800 md:hover:text-gray-600 hover:text-sky-800">
            <router-link to="" exact-active-class="text-red-900"> Contact Us </router-link>         
          </li>
            </ul>
          </nav>
        </section>
      ...
      <section class=" relative z-10 overflow-hidden bg-opacity-30 bg-slate-500 py-2 md:py-5"
        id="contact">
              ...
              <div class="-mx-4 flex flex-wrap lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                  ...
                  <div class="mb-8 flex w-full max-w-[370px]">
                    <div
                      class="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[30px] sm:max-w-[70px]"
                    >
                      <svg
                        width="24"
                        height="24"
                  ...
                  <div class="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div class="w-full">
                      ...
                      <p class="text-body-color text-base">+88-02-8431645-53, 8432065-76</p>
                    </div>
                  </div>
                  <div class="mb-8 flex w-full max-w-[370px]">
                      <div
                      ...
                      <div class="w-full">
                        ...
                        <p class="text-body-color text-base">info@iub.edu.bd</p>
                      </div>
                  </div>
              </div>
            </div>
                ...
                <form>
                  ...
                  <div>
                    <button
                      ...
                      rounded border p-3 hover:bg-slate-400 "
                    >
                      Send Message
                    </button>
                  </div>
